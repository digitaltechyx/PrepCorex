...
import { WarehouseOpsNotifications } from "@/components/warehouse-ops/warehouse-ops-notifications";
...
export default function WarehouseOpsNotificationsPage() {
  ...
  return <WarehouseOpsNotifications warehouse={selectedWarehouse} />;
}
