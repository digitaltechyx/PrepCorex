...
const ALLOWED_TRANSITIONS: Record<WarehouseCartonStatus, WarehouseCartonStatus[]> = {
  ...
  quarantine: ["available", "damaged", "on_hold", "expired", "closed", "voided", "received", "stowed_partial", "stowed"],
  damaged: ["quarantine", "on_hold", "expired", "closed", "voided", "received", "available"],
  on_hold: ["available", "quarantine", "damaged", "expired", "closed", "voided", "received", "stowed_partial"],
